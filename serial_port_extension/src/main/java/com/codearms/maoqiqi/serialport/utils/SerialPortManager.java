...
public class SerialPortManager {
    ...
    // 打开串口
    public SerialPort open(String path, int baudRate, int dataBits, int stopBits, int parity, int flags) {
        if (serialPort == null) {
            try {
                // 打开串口
                serialPort = new SerialPort(new File(path), baudRate, dataBits, stopBits, parity, flags);
